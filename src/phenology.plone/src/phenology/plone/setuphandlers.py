...
from phenology.plone import PRODUCT_DEPENDENCIES

logger = logging.getLogger('phenology.plone / setuphandler')
...
def setupVarious(context):
    ...
    if context.readDataFile('phenology.plone_various.txt') is None:
        return
...
def setupQi(context):
    ...
    if context.readDataFile('phenology.plone_qi.txt') is None:
        return

    portal = context.getSite()
    portal_quickinstaller = getToolByName(portal, 'portal_quickinstaller')
    #portal_setup = getToolByName(portal, 'portal_setup')
    logger = logging.getLogger('phenology.plone.Install')
