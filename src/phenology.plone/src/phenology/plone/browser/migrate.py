...
from phenology.plone.setuphandlers import setup_catalog
from phenology.plone import upgrades


ENABLED = 1
PRODUCT = 'phenology.plone'
log = upgrades.log
move = upgrades.move
...
class FilePhenologyPloneMigrator(BlobMigrator):
    src_portal_type = 'FilePhenologyPlone'
    src_meta_type = 'FilePhenologyPlone'
    dst_portal_type = 'FilePhenologyPlone'
    dst_meta_type = 'FilePhenologyPlone'


class PhenologyPlone_migrate(grok.View):
    ...
    def custom_hook_blob(self):
        self.migrate_filePhenologyPlone_to_blob()
    ...
    def custom_hook_after_plone_upgrade(self):
        ...
        ps.runImportStepFromProfile(
            'profile-PhenologyPlone.skin:default', "skins", run_dependencies=False)
