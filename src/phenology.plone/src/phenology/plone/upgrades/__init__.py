...
def upgrade_1000(context):
    ...
    #portal_setup.runImportStepFromProfile(
    #    'profile-phenology.plone:default', 'jsregistry', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-phenology.plone:default', 'cssregistry', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-phenology.plone:default', 'portlets', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-phenology.plone:default', 'propertiestool', run_dependencies=False)
    log('v1000 applied')
